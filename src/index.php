    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-4">
                ...
                <a href="/PHPProjectPOS/src/view/viewProduct.php?id=1"
                    class="px-3 py-2 bg-red-300 hover:bg-red-500 hover:text-gray-200 rounded-xl">View Details</a>
            </div>
        </div>
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-4">
                <h3 class="text-lg font-bold mb-2">Product Name</h3>
                <p class="text-gray-700 mb-2">$20.00</p>
                <a href="/PHPProjectPOS/src/view/aaaaa.jpg"
                    class="px-3 py-2 bg-red-300 hover:bg-red-500 hover:text-gray-200 rounded-xl">View Details</a>
            </div>
        </div>
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
...
<section class="container mx-auto py-8">
    <div class="flex flex-col md:flex-row gap-6">
        <div class="w-full md:w-1/2">
            <img src="PHPProjectPOS/src/path/22-05-2024-03-29-14.png" alt="Product Name"
    ...
    <section id="productList" class="bg-white p-4 rounded-lg shadow-md">
        ...
        <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <li class="bg-slate-200 rounded-lg p-3">
                <img src="path/aaaaa.jpg" alt="Product 1" class="w-full h-32 object-cover rounded-lg mb-3">
                <h3 class="text-xl font-semibold mb-2">Lasko 20" Classic Box Fan with Weather-Resistant Motor, 3 Speeds,
                    22.5" H, White, B20200, New</h3>
                ...
                <div class="flex items-center mb-2">
                    <button class="px-2 py-1 bg-gray-300 hover:bg-gray-400 rounded"
                        onclick="decreaseQuantity('product1')">-</button>
                    <span id="quantity-product1" class="mx-2">1</span>
                    <button class="px-2 py-1 bg-gray-300 hover:bg-gray-400 rounded"
                        onclick="increaseQuantity('product1')">+</button>
                </div>
            ...
            <li class="bg-slate-200 rounded-lg p-3">
                ...
                <div class="flex items-center mb-2">
                    <button class="px-2 py-1 bg-gray-300 hover:bg-gray-400 rounded"
                        onclick="decreaseQuantity('product2')">-</button>
                    <span id="quantity-product2" class="mx-2">1</span>
                    <button class="px-2 py-1 bg-gray-300 hover:bg-gray-400 rounded"
                        onclick="increaseQuantity('product2')">+</button>
                </div>
                <div class="text-right mb-2">
            ...
            <li class="bg-slate-200 rounded-lg p-3">
                ...
                <div class="flex items-center mb-2">
                    <button class="px-2 py-1 bg-gray-300 hover:bg-gray-400 rounded"
                        onclick="decreaseQuantity('product3')">-</button>
                    <span id="quantity-product3" class="mx-2">1</span>
                    <button class="px-2 py-1 bg-gray-300 hover:bg-gray-400 rounded"
                        onclick="increaseQuantity('product3')">+</button>
                </div>
                <div class="text-right mb-2">
